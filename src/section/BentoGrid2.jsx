      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-400 text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
            We're more than just a marketing agency—we're your strategic partner in growth.
          </p>
        </div>

        {/* Bento Grid - 4x3 layout with center image */}
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-3 gap-4 md:gap-5">
          
          {/* Top Left - Our Mission */}
          <div
            className={`md:col-span-2 md:row-span-1 group relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 to-blue-800 transition-all duration-500 ease-out ${
          ...
          <div
            className={`md:col-span-2 md:row-span-1 group relative overflow-hidden rounded-3xl bg-neutral-800 border border-neutral-700 transition-all duration-500 ease-out hover:border-neutral-600 ${
          ...
          <div
            className={`md:col-span-1 md:row-span-2 group relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-600 to-pink-600 transition-all duration-500 ease-out ${
          ...
          {/* CENTER - Team Image */}
          <div
            className={`md:col-span-2 md:row-span-2 group relative overflow-hidden rounded-3xl bg-neutral-800 border-2 border-neutral-700 transition-all duration-500 ease-out hover:border-neutral-500 ${
          ...
          >
            ...
            <div className="relative h-full w-full bg-gradient-to-br from-neutral-700 to-neutral-900 flex items-center justify-center">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-neutral-900 to-transparent transform translate-y-full group-hover:translate-y-0 transition-transform duration-500">
                <p className="text-white text-center font-semibold">The Team Behind Your Success</p>
              </div>
            </div>
          </div>
          ...
          <div
            className={`md:col-span-1 md:row-span-2 group relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-600 to-teal-600 transition-all duration-500 ease-out ${
          ...
          <div
            className={`md:col-span-2 md:row-span-1 group relative overflow-hidden rounded-3xl bg-gradient-to-br from-orange-600 to-red-600 transition-all duration-500 ease-out cursor-pointer ${
